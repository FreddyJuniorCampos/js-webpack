...
import gitthub from '../assets/images/github.png'
    ...
    <div class="About">
      <div class="card">
        ...
        <div class="card_social">
          <a href="https://twitter.com/FreddyJuniorC1">
            <img src="${twitter}" />
          </a>
          <a href="https://github.com/FreddyJuniorCampos">
            <img src="${gitthub}" />
          </a>
          <a href="https://instagram.com/freddyjunior1">
            <img src="${instagram}" />
          </a>
        </div>
      </div>
